        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center mb-4">
              ...
              <span className="ml-2 text-xl font-bold text-gradient">Skill Swap</span>
            </div>
            <p className="text-gray-600 mb-4 max-w-md">
              Connect with others to exchange skills and knowledge. Learn from each other and grow together in a collaborative community.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/explore" className="text-gray-600 hover:text-primary-600 transition-colors duration-200">
                  Explore Skills
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/profile" className="text-gray-600 hover:text-primary-600 transition-colors duration-200">
                  My Profile
                </Link>
              </li>
              <li>
                <Link to="/swap-requests" className="text-gray-600 hover:text-primary-600 transition-colors duration-200">
                  Swap Requests
                </Link>
              </li>
            </ul>
